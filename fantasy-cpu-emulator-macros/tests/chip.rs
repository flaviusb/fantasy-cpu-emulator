...
define_chip! {
  ...
  Add,    1 0 1 0 1 1 a:[u; 10] b:[u; 10] c:[u; 10], MemoryToArchitecturalRegisters <- 1 super::super::Instruction::Add(super::super::Instructions::Add{a, b, c}) => {use super::super::fetch; let (m, n, o) = (fetch(a), fetch(b), fetch(c)); Instruction::Add(Add{a: m, b: n, c: o})} -> Add -> pub struct Add{a: super::super::U36, b: super::super::U36, c: super::super::U36}, "Add things, 36 bit."
